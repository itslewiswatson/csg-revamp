...
addEventHandler("boneAttach_sendAttachmentData",localPlayer,getAttachmentData)

function initAttach()
	addEvent("boneAttach_attach",true)
	addEvent("boneAttach_detach",true)
	addEventHandler("boneAttach_attach",localPlayer,attachElementToBone)
	addEventHandler("boneAttach_detach",localPlayer,detachElementFromBone)
end
