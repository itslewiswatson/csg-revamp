...
function createSewerFlood()
	...
	-- Water #1
	local xmin, xmax, ymin, ymax, z = 1330, 1420, -1733, -1298, 10.4
	local water = createWater(xmin, ymin, z, xmax, ymin, z, xmin, ymax, z, xmax, ymax, z)
	
	-- Water #2
	local xmin, xmax, ymin, ymax, z = 1574, 2534, -1917, -1729, 8
	local water = createWater(xmin, ymin, z, xmax, ymin, z, xmin, ymax, z, xmax, ymax, z)
	
	-- Water #3
	local xmin, xmax, ymin, ymax, z = 1613, 1629, -1729, -1680, 8
	local water = createWater(xmin, ymin, z, xmax, ymin, z, xmin, ymax, z, xmax, ymax, z)
	
	-- Water #4
	local xmin, xmax, ymin, ymax, z = 2534, 2628, -2115, -1452, 8
	local water = createWater(xmin, ymin, z, xmax, ymin, z, xmin, ymax, z, xmax, ymax, z)
end
