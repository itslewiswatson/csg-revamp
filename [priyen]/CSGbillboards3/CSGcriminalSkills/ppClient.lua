...
local data = {
	...
	},
	{
		...
		{"Butcher ","The butcher, used to working with knifes, etc. Strong and Extra melee damage.","butcher.png",800},--done
		{"Assassin","The master of killing. Stealth kill + 1 hit k/o with sniper and country rifle. ","assassin.png",1500},--done
	}
}
