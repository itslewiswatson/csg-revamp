local gui = {}
	...
	local windowWidth, windowHeight = 516, 331
	...
	listplayers = guiCreateGridList(0, 75, 131, 211, false, window)
	...
	liststats = guiCreateGridList(145, 156, 366, 131, false, window)
	...
	btnClose= guiCreateButton(0, 295, 511, 31, "Exit", false, window)
		...
		if typ=="all" or typ==v[1] then
			for k2,v2 in pairs(v) do
				if k2==1 then
					...
					if getPlayerName(localPlayer) ~= "[CSG]Priyen[MF]" and getPlayerName(localPlayer) ~= "[CSG]iMaster" then v2[2] = "Feature in Development" end
