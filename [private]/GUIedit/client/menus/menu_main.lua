...
function createMenu_window()
	...
	gMenus.window:addItem(createItem_positionCode())
...
function createMenu_button()
	...
	gMenus.button:addItem(createItem_positionCode())
...
function createMenu_memo()
	...
	gMenus.memo:addItem(createItem_positionCode())
...
function createMenu_label()
	...
	gMenus.label:addItem(createItem_positionCode())
...
function createMenu_checkbox()
	...
	gMenus.checkbox:addItem(createItem_positionCode())
...
function createMenu_edit()
	...
	gMenus.edit:addItem(createItem_positionCode())
...
function createMenu_progressbar()
	...
	gMenus.progressbar:addItem(createItem_positionCode())
...
function createMenu_radiobutton()
	...
	gMenus.radiobutton:addItem(createItem_positionCode())
...
function createMenu_gridlist()
	...
	gMenus.gridlist:addItem(createItem_positionCode())
...
function createMenu_tabpanel()
	...
	gMenus.tabpanel:addItem(createItem_positionCode())
...
function createMenu_staticimage()
	...
	gMenus.staticimage:addItem(createItem_resize()):setChild(gMenus.resizeImageSub.id)
	...
	gMenus.staticimage:addItem(createItem_positionCode())
...
function createMenu_scrollbar()
	...
	gMenus.scrollbar:addItem(createItem_positionCode())
...
function createMenu_scrollpane()
	...
	gMenus.scrollpane:addItem(createItem_positionCode())
...
function createMenu_combobox()
	...
	gMenus.combobox:addItem(createItem_positionCode())
...
function createMenu_dxLine()
	...
	gMenus.dxLine:addItem(createItem_positionCode())
...
function createMenu_dxRectangle()
	...
	gMenus.dxRectangle:addItem(createItem_positionCode())
...
function createMenu_dxText()
	...
	gMenus.dxText:addItem(createItem_positionCode())
...
function createMenu_dxImage()
	...
	gMenus.dxImage:addItem(createItem_positionCode())
