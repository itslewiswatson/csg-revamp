...
function depositMoney ()
	...
	elseif string.match(guiGetText(edits[1]),'^%d+$') then
		...
		if tonumber(value) > tonumber(playerMoney) or playerMoney == 0 then
			exports.DENdxmsg:createNewDxMessage("You can't deposit this much money, because you dont have it!", 200,0,0)
		elseif tonumber(guiGetText ( edits[1] )) < 749 then
			exports.DENdxmsg:createNewDxMessage("The minimum deposit is $750!", 200,0,0)
			guiSetText ( edits[1], "" )
		else
