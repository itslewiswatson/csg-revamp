...
function enableDetail()
	...
	-- Load textures
	detail22Texture = dxCreateTexture('detailshader/media/detail22.png', "dxt3")
	detail58Texture = dxCreateTexture('detailshader/media/detail58.png', "dxt3")
	detail68Texture = dxCreateTexture('detailshader/media/detail68.png', "dxt1")
	detail63Texture = dxCreateTexture('detailshader/media/detail63.png', "dxt3")
	dirtyTexture = dxCreateTexture('detailshader/media/dirty.png', "dxt3")
	detail04Texture = dxCreateTexture('detailshader/media/detail04.png', "dxt3")
	detail29Texture = dxCreateTexture('detailshader/media/detail29.png', "dxt3")
	detail55Texture = dxCreateTexture('detailshader/media/detail55.png', "dxt3")
	detail35TTexture = dxCreateTexture('detailshader/media/detail35T.png', "dxt3")
...
function getMakeShader(v)
	...
	local shader,tec = dxCreateShader ( "detailshader/fx/detail.fx", 1, 100 )
	if shader then
