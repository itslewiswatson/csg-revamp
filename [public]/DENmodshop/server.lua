...
addEventHandler( "onResourceStart", resourceRoot,
	function ()
		for i=1,#modshopPositions do
			local aMarker = createMarker( modshopPositions[ i ][ 1 ], modshopPositions[ i ][ 2 ], modshopPositions[ i ][ 3 ], "cylinder", 2.0, 225, 0, 0 )
			createBlip ( modshopPositions[ i ][ 1 ], modshopPositions[ i ][ 2 ], modshopPositions[ i ][ 3 ], 27, 0, 0, 0, 0, 0, 0, 250 )
