...
function drawRaceGUI ()
	...
	-- countdown
		...
		if countdown then
			...
			dxDrawText ( tostring(countdown), 5, 5, sW, 350, tocolor ( 0 ), 9, "bankgothic", "center", "center", false, true, true, false, true ) -- shadow
		
			dxDrawText ( tostring(countdown), 0, 0, sW-10, 340, tocolor ( r,g,b ), 9, "bankgothic", "center", "center", false, true, true, false, true )
	...
	-- race info bottom
		if race_checkpoints and race_checkpoints_hit and not playerFinished then
			...
			dxDrawText(text,startX-2,startY-2,endX+4,endY+4,tocolor(0,0,0,255),3.0,"default","left","bottom",false,false,false) -- shadow
			dxDrawText(text,startX,startY,endX,endY,tocolor(255,255,255,255),3.0,"default","left","bottom",false,false,false)			
		
		end
		
	-- positions & lap ( if applying )
