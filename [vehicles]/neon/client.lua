...
[489] = {"Rancher", 0, 7, 0, 0},
[560] = {"Sultan",0,7,0,0},
[411] = {"Infernus",0,7,0,0},
[522] = {"NRG-500",0,7,0,0},
}

local smurfsAir = {
[487]={"Maverick",0,7,0,0},
}
...
-- SM base
    --sm air
{2198.6, 583.36, 28.12,0,0,0,smurfsAir,"Criminals","Criminal",85.8,"aGroup",nil,nil,nil,"The Smurfs"},
	--sm group
{ 2194.06, 573.66, 12.16, 0, 0, 0, smurfs, "Criminals", "Criminal", 266 , "aGroup", nil, nil, nil, "The Smurfs" },
-- Yakuza base
{ 891.88, 2147.45, 10.5 , 0, 0, 0, crimBaseVehicles, "Criminals", "Criminal", 85 , "aGroup", nil, nil, nil, "The YaKuZa Family"},
{ 891.87, 2152.64, 10.5 , 0, 0, 0, crimBaseVehicles, "Criminals", "Criminal", 85 , "aGroup", nil, nil, nil, "The YaKuZa Family"},
-- Wolfensteins base
{ 987.81, 1465.35, 14.36, 0, 0, 156, wolfBase, "Criminals", "Criminal", 90 , "aGroup", nil, nil, nil, "Wolfensteins" },
{ 983.08, 1481.58, 14.36, 0, 0, 156, wolfAir, "Criminals", "Criminal", 90 , "aGroup", nil, nil, nil, "Wolfensteins" },

-- LCN base
{ 1252.8, 744.5,13.2989, 68,68,68, crimBaseVehicles, "Criminals", "Criminal", 260, "aGroup", nil, nil, nil, "La Cosa Nostra" },
-- Champions base
{ 2960.92, 1163.23, 40.81,68,68,68,crimBaseVehicles, "Criminals", "Criminal", 82 , "aGroup", nil, nil, nil, "The Champions" },
{ 2960.74, 1169.18, 40.81,68,68,68,crimBaseVehicles, "Criminals", "Criminal", 82 , "aGroup", nil, nil, nil, "The Champions" },
-- Invaders base
{ 2861.57, 1863.49, 19.08,68,68,68,invBase, "Criminals", "Criminal", 172 , "aGroup", nil, nil, nil, "Invaders" },
{2832.55, 1890.19, 39.96,68,68,68,invAir, "Criminals", "Criminal", 172 , "aGroup", nil, nil, nil, "Invaders" },
...
--News Reporter
{751.45, -1341.09, 13.52,255,255,0,newsVehicles,"Civilian Workers", "News Reporter"},
