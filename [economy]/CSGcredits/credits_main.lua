...
function(table,dAccountID,dAccountName)
	if mainVisible == false then
		if (table and dAccountID and dAccountName) then
			credits = table.credits
			totalCredits = table.creditsSpent
			moneySpent = table.moneySpent
			itempackages = table.itemsBought
			accountID = dAccountID
			accountName = dAccountName
			outputDebugString("credits: "..credits.." total: "..totalCredits.." spent: "..moneySpent.." item: "..itempackages.." ID: "..accountID.." name: "..accountName)
		end
