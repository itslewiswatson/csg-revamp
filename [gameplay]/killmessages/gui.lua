...
addEvent ( "doOutputStaffMessage", true )
function outputStaffMessage ( message, r, g, b, font )
	if type(message) ~= "string" and type(message) ~= "table" then
		outputDebugString ( "outputMessage - Bad 'message' argument", 0, 112, 112, 112 ) 
		return false 
	end
...
addEventHandler ( "doOutputStaffMessage", getRootElement(), outputStaffMessage )
