...
function readScoreboardSettings()
	...
	settings.showserverinfo = true --iif( settings.showserverinfo and tostring( settings.showserverinfo ) == "true", true, false )

	settings.showgamemodeinfo = xmlNodeGetValue( showgamemodeinfoTag )
	settings.showgamemodeinfo = true --iif( settings.showgamemodeinfo and tostring( settings.showgamemodeinfo ) == "true", true, false )
